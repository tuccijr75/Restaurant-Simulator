...
EVENT_TYPES=set('shift.started order.created item.sold ticket.updated staff.assignment.updated prep.confirmed waste.recorded station.overloaded station.recovered shift.ended