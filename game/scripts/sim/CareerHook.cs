...
public partial class CareerHook : Node
{
    ...
    public bool ConfigureSim(SimRunState sim)
    {
        ...
        // RS-IM-001: real per-ingredient inventory/waste model (replay-neutral).
        sim.EnableRealIngredients = true;
        sim.Catalog = LoadCatalog();
    ...
    static IngredientCatalog LoadCatalog()
    {
        // Prefer the editable res:// catalog; fall back to the embedded copy.
        try
        {
            const string path = "res://game/config/ingredients.json";
