...
public class SimRunState{
 public int Seed=12345; public string Scenario="normal_day"; public bool Running,StationOverloaded;
 public double Minute=360; public int Orders,DriveThru,FrontCounter,Delivery,Mobile; double acc,over,recover;
 ...
 void UpdateOverload(double m){if(DelayRisk){over+=m;recover=0;if(over>=5)StationOverloaded=true;}else{over=0;if(StationOverloaded){recover+=m;if(recover>=4)StationOverloaded=false;}}}
