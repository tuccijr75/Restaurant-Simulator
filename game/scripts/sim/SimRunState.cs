...
public class SimRunState{
 public int Seed=12345; public string Scenario="normal_day",RecentEvents=""; public bool Running,StationOverloaded;
 ...
 void Emit(string t){EventSeq++;RecentEvents=$"{EventSeq} {TimeText} {t}\n"+RecentEvents;if(RecentEvents.Length>500)RecentEvents=RecentEvents[..500];}
