...
public class SimRunState{
 ...
 string StationPayload()=>$"{{\"fryer_load\":{FryerLoad},\"grill_load\":{GrillLoad},\"assembly_load\":{AssemblyLoad},\"expo_load\":{ExpoLoad},\"kitchen_load\":{KitchenLoad},\"staff_capacity\":{StaffCapacity},\"net_load\":{NetKitchenLoad}}}";
