...
public class SimRunState{
 ...
 void EnsureEquipment(){if(equipmentReady)return;equipmentReady=true;AddEquipment("fryer_fries_1","fryer","fries",70);AddEquipment("fryer_fries_2","fryer","fries",70);AddEquipment("fryer_main_1","fryer","fried_main",70);AddEquipment("fryer_main_2","fryer","fried_main",70);AddEquipment("burger_press_1","grill","grilled_main",95);AddEquipment("soda_1","beverage","beverage",45);AddEquipment("soda_2","beverage","beverage",45);AddEquipment("soda_3","beverage","beverage",45);AddEquipment("soda_4","beverage","beverage",45);AddEquipment("assembly_rail_1","assembly","assembly",60);AddEquipment("assembly_rail_2","assembly","assembly",60);AddEquipment("expo_lane_1","expo","expo",65);AddEquipment("expo_lane_2","expo","expo",65);AddEquipment("dt_window_1","drive_thru","dt_service",60);AddEquipment("dt_window_2","drive_thru","dt_service",60);AddEquipment("counter_pos_1","lobby","counter_service",60);AddEquipment("counter_pos_2","lobby","counter_service",60);AddEquipment("pickup_shelf_1","pickup","pickup_service",80);// RS-HQ-001: mains/fries are cook-to-hold (full-cycle latency lives in the pan,
